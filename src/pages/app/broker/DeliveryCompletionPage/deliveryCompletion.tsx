...
import {PODFileList, SignatureFileList, PictureFileList} from './components/FileLists';
...
export function DeliveryCompletion() {
  ...
  const removePoDFile = useCallback((filename: string) => {
    const filteredArry: pictureFile[] = podFiles.filter(file => file.name !== filename)
        ...
        <OuterBlueDivBox>
          ...
          <InnerWhiteDivBox style={{ padding: 25 }}>
            ...
            <Grid container justifyContent="center">
                <MediumButton onClick={handleClosePODCameraOpen} variant="contained" >Add</MediumButton>
            </Grid>
          ...
          <InnerWhiteDivBox style={{ padding: 25 }}>
            ...
            <Grid container justifyContent="center">
                <MediumButton onClick={handleCloseCameraOpen} variant="contained" >Add</MediumButton>
            </Grid>
